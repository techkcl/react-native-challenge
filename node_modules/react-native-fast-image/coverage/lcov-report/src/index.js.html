...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import React, { forwardRef, memo } from 'react'
...
&nbsp;
FastImage.preload = <span class="fstat-no" title="function not covered" >so</span>urces =&gt; {
<span class="cstat-no" title="statement not covered" >    FastImageViewNativeModule.preload(sources)</span>
}
&nbsp;
